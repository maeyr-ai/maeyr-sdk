...
from viksa_ai.client.errors import ViksaStreamError
...
class JsonSseDecoder:
    ...
    def _dispatch(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            raise ViksaStreamError("Stream returned malformed JSON event") from exc
        if not isinstance(value, dict):
            raise ViksaStreamError("Stream returned a non-object JSON event")

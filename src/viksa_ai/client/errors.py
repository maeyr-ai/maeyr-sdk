"""Structured errors for the Viksa platform HTTP client."""
...
class ViksaError(Exception):
    """Base exception for all Viksa SDK errors."""


class ViksaTransportError(ViksaError):
...
class ViksaAuthenticationError(ViksaApiError):
    """401 Unauthorized."""


class ViksaPermissionError(ViksaApiError):
    """403 Forbidden."""


class ViksaNotFoundError(ViksaApiError):
    """404 Not Found."""


class ViksaConflictError(ViksaApiError):
    """409 Conflict."""


class ViksaValidationError(ViksaApiError):
    """422 Unprocessable Entity."""


class ViksaRateLimitError(ViksaApiError):
    """429 Too Many Requests."""


class ViksaServerError(ViksaApiError):
    """5xx server error."""


_STATUS_TO_EXCEPTION: Dict[int, type[ViksaApiError]] = {
    401: ViksaAuthenticationError,
    403: ViksaPermissionError,
    404: ViksaNotFoundError,
    409: ViksaConflictError,
    422: ViksaValidationError,
    429: ViksaRateLimitError,
}
...
def raise_for_response(
    ...
    *,
    ...
    """Raise a typed :class:`ViksaApiError` subclass for error HTTP statuses."""
    ...
    exc_type: type[ViksaApiError]
    if status >= 500:
        exc_type = ViksaServerError
    else:
        exc_type = _STATUS_TO_EXCEPTION.get(status, ViksaApiError)

...
from maeyr.devtools.validate_agent import AgentValidationError, validate_agent_manifest
from maeyr.models.agent import AgentGenerationResponse


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate a Maeyr agent manifest")
    parser.add_argument(
        "path",
        type=Path,

...
from maeyr_platform.security.internal_key_guard import assert_production_internal_key
from maeyr_platform.security.internal_tenant_guard import (
    require_internal_tenant_fields,
    validate_internal_tenant_body,
)
from maeyr_platform.security.internal_tenant_headers import internal_tenant_headers
from maeyr_platform.security.jwt_secret_guard import (
...
def test_security_compatibility_modules_preserve_import_identity() -> None:
    implementation = import_module("maeyr_platform.security.internal")
    assert import_module("maeyr_platform.security.internal_request_signing") is implementation
    assert import_module("maeyr_platform.compat.internal_request_signing") is implementation
    tenant_headers = import_module("maeyr_platform.security.internal_tenant_headers")
    assert import_module("maeyr_platform.compat.internal_tenant_headers") is tenant_headers

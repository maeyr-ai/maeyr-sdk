...
from maeyr_platform.metrics.billing import UsageDeliveryRejected, canonicalize_usage_event
from maeyr_platform.metrics.constants import entity_type_from_resource_type
from maeyr_platform.metrics.context import _call_counter, get_usage_context
from maeyr_platform.metrics.resource_refs import build_resource_refs, merge_resource_refs
from maeyr_platform.metrics.transport import enqueue_event
...
async def stop_recorder() -> None:
    ...
    _flush_wakeup = None
    _automatically_started = False
    from maeyr_platform.metrics.transport import queue_length
...
def get_recorder_stats() -> dict[str, Any]:
    from maeyr_platform.metrics.transport import get_transport_stats

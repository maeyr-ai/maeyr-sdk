...
from maeyr_platform.auth.fastapi_validator import get_logged_user
from maeyr_platform.security.tenant_safe_display import public_http_detail

logger = getLogger("[maeyr_platform.auth.permission_checker]")
